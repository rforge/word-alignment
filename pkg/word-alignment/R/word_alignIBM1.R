word_alignIBM1 <-
function(filename1,filename2,nrec=-1,skipped=0,maxlength=40,lu1=TRUE,lu2=FALSE,iter=10,lang1='English',lang2='Farsi',prob=0.9,first=1,last=5)
{
...
#--------------------------Translation:f to e -----------------------------------
e=f=a=b=t=bb=c()
e=as.character(read.delim(filename1,nrows=nrec,sep='\n',skip=skipped,encod='UTF-8',header=FALSE)[[1]])
f=as.character(read.delim(filename2,nrows=nrec,sep='\n',skip=skipped,encod='UTF-8',header=FALSE)[[1]])
