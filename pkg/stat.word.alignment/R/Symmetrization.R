...
ef1 = word_alignIBM1 (file1, file2, nrec = nrec, iter = iter, map = 'ef1', word1 = FALSE, number = TRUE, sym = TRUE, la = la)

fe1 = word_alignIBM1 (file1, file2, nrec = nrec, iter = iter, map = 'fe1', word1 = FALSE, number = TRUE, la = la)
ll = length (fe1)
...
mylist = list(time = date2 - date1, method = method, alignment = align_un[first:last])
return (mylist)
}
#----------------------------------------------------------------
...
mylist = list(time = date2 - date1, method = method, alignment = align_in[first:last] )
return(mylist)
}
#----------------------------------------------------------------
...
mylist = list(time = date2 - date1, method = method, alignment = symmet[first:last])
return(mylist)
}
}
