word_alignIBM1 <-
function(file1,file2,nrec = -1,iter = 4,mlen = 40,lus = FALSE,lut = TRUE,map = c('ef1','fe1'),sym = FALSE,input = FALSE,dtfile = NULL,word1 = TRUE,number = FALSE,la = TRUE,first = 1,last = 5)
{
map = match.arg (map)
