...
cat("Number of iteration for IBM model 1 is ", x[[4]], "\n")
cat("Word alignment for some sentence pairs are", "\n")
print (as.character(x $ word_align[1 : 3]))
cat("            ", ".", "\n")
cat("            ", ".", "\n")
cat("            ", ".", "\n")
print (as.character(x $ word_align[(length(x $ word_align) - 2) : length(x $ word_align) ] ))
}
