word_alignIBM1 <-
function(file_train1, file_train2, f1 = 'fa',e1 = 'en', nrec = -1, iter = 4, maxlen = 40, ul_s = FALSE, ul_t = TRUE, sym = FALSE, input = FALSE, dtfile = NULL, display = c("word1","number"), intrnt = TRUE, first = 1, last = 5)
{
...
#-----------------------Translation:f to e ----------------------
aa = preparData (file_train1, file_train2, nrec = nrec, maxlen = maxlen, ul_s = ul_s, ul_t = ul_t, intrnt = intrnt)
