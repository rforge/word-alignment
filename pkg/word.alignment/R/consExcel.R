consExcel <-
function(sou,tar,gold=TRUE,aligns=FALSE,out1='g.xlsx',out2='a.xlsx',nrec= -1,mlen=40,lus=FALSE,lut=TRUE)
{
p1 = preparData (sou, tar, nrec = nrec, mlen = mlen, lus = lus, lut = lut)
...
print ("Now, please edit 'g.xlsx' to enter Sure/Possible alignments (Sure=1, Possible=2)")
}
...
print("Now, please edit 'a.xlsx' to enter '3' for alignments.")
}
}
