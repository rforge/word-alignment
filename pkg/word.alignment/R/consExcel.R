consExcel <-
function(tst.set_sorc, tst.set_trgt, method = c ("gold", "aligns"), out1 = "gold.xlsx", out2 = "align.xlsx", nrec = -1, minlen = 5, maxlen = 40, ul_s = FALSE, ul_t = TRUE)
{
method = match.arg(method)

p1 = preparData (tst.set_sorc, tst.set_trgt, nrec = nrec, minlen = minlen, maxlen = maxlen, ul_s = ul_s, ul_t = ul_t)
len = p1 $ used
