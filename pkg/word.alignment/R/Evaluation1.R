Evaluation1 <-
function(file1,file2,source1,target1,method = c('fix', 'Excel'),excel1 = 'gold.xlsx',excel2 = 'align.xlsx',align1 = c('myalign', 'an.align'),dtfile = NULL,nrec = -1,nlen = -1,mlen = 40,lus = FALSE,lut = TRUE,iter = 3,la = TRUE)
{
