mydictionary <-
function (file_train1,file_train2, nrec = -1, iter = 10, prob = 0.9, minlen=5, maxlen = 40, ul_s = FALSE, ul_t = TRUE, lang1 = 'Farsi', lang2 = 'English', intrnt = TRUE, dtfile = NULL, f1 = 'fa', e1 = 'en')
{
...
if(is.null (dtfile))
{
dd1 = word_alignIBM1 (file_train1, file_train2, minlen = minlen, maxlen = maxlen, iter = iter, nrec = nrec, ul_s = ul_s, ul_t = ul_t, input = TRUE, intrnt = intrnt)
