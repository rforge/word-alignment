preparData <-
function(file1, file2, nrec = -1, maxlen = 40, ul_s = FALSE, ul_t = TRUE, all = FALSE, intrnt = TRUE)
{
s_sen = t_sen = aa = t = c()
...
aa = aa [apply (aa, 1, function(x) prod (vapply (strsplit (x, ' '), length, FUN.VALUE=0) <= maxlen) == 1) ,]
